...
var debug = debug_1.default('apkup:helpers');
/**
 * Parse the manifest of an APK file
 * @param apk Path to the APK file
 */
exports.parseManifest = function (apk) { return __awaiter(_this, void 0, void 0, function () {
    var apkFile, reader, manifest;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                debug('> Parsing manifest');
                apkFile = typeof apk !== 'string' ? apk[0] : apk;
                return [4 /*yield*/, adbkit_apkreader_1.default.open(apkFile)];
            case 1:
                reader = _a.sent();
 ...
 */
exports.checkTrack = function (track) {
    return exports.tracks.includes(track);
};
